...
function Zt(t, e, n) {
  ...
  function Q(E, G) {
    ...
    const I = X[0], D = Array.from(I.element.element.children).map((oe) => oe.getAttribute("name") ?? "");
  ...
  function B(E) {
    const { selectedIndexes: G, selectedMergeTargetIndex: z } = E.detail, le = i[y], X = G.map((oe) => le[oe]), x = le[z], U = { action: { actions: X.map((oe) => oe.usages.map((re) => Wt(re, x.element))).flat() } }, D = new CustomEvent("editor-action", { detail: U, composed: !0, bubbles: !0 });
    s.dispatchEvent(D);
  }
  function V(E) {
    De[E ? "unshift" : "push"](() => {
...
const rt = "@oscd-plugins/dedupe", xt = "0.0.8";
function Ze(t) {
  let e = (
    /*doc*/
    t[0]
