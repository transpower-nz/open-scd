...
const me = [], De = [], ke = [], Ie = [], ft = Promise.resolve();
let we = !1;
function dt() {
  we || (we = !0, ft.then(lt));
}
...
function te(t, e, n, r, l, c, s, o = [-1]) {
  ...
  if (u.ctx = n ? n(t, e.props || {}, (d, p, ...y) => {
    ...
    e.intro && S(t.$$.fragment), Z(t, e.target, e.anchor, e.customElement), lt();
  }
  be(i);
}
class ne {
...
const P = class {
  ...
  searchElementsByLnTypeAttr(t, e) {
    const n = `[lnType='${t}']`;
    return this.searchElement(n, [], e);
  }
  // 
...
class Et {
  ...
  findUserElements(e) {
    return [
      ...this.scdQueries.searchElementsByTypeAttr(e),
      ...this.scdQueries.searchElementsByLnTypeAttr(e)
    ];
  }
...
class At extends ne {
  constructor(e) {
    super(), te(this, e, wt, Dt, K, { count: 0, max: 1 });
  }
}
function Ge(t, e, n) {
  const r = t.slice();
  ...
  return s = new At({
    ...
    c() {
      ...
      for (let p = 0; p < d.length; p += 1)
        d[p].c();
      l = O(), c = g("div"), ee(s.$$.fragment), b(r, "class", "svelte-kezdla"), b(n, "class", "left svelte-kezdla"), b(c, "class", "right svelte-kezdla"), he(
        e,
        "data-testid",
        /*dataTestid*/
        t[1]
    ...
    m(p, y) {
      ...
      for (let k = 0; k < d.length; k += 1)
        d[k].m(r, null);
      h(e, l), h(e, c), Z(s, c, null), o = !0, i || (u = [
        oe(
          e,
          "click",
          /*click_handler*/
...
class It extends ne {
  constructor(e) {
    super(), te(this, e, Lt, Nt, K, { items: 0, dataTestid: 1, selected: 2 });
  }
}
function je(t, e, n) {
  const r = t.slice();
...
class Mt extends ne {
  constructor(e) {
    super(), te(this, e, Gt, Ot, K, { itemSets: 0, selectedIndex: 1 });
  }
}
function jt(t) {
  let e, n, r, l, c;
...
function zt(t) {
  ...
  return {
    c() {
      e = g("checkbox"), n = g("label"), r = g("input"), l = O(), c = g("span"), s = j(
        /*label*/
        t[1]
...
class qt extends ne {
  constructor(e) {
    super(), te(this, e, Bt, zt, K, { checked: 0, label: 1, testid: 2 });
  }
}
function Be(t, e, n) {
  const r = t.slice();
...
function Fe(t) {
  ...
  return n = new qt({
    ...
    c() {
      e = g("li"), ee(n.$$.fragment), r = O();
    },
    m(s, o) {
      A(s, e, o), Z(n, e, null), h(e, r), l = !0;
    },
    p(s, o) {
      t = s;
      const i = {};
...
function Ue(t) {
  ...
  return {
    ...
    p(p, y) {
      y & /*affectedElements*/
      16 && r !== (r = /*element*/
      p[18].type + "") && Y(l, r), y & /*affectedElements*/
      16 && s !== (s = /*element*/
      p[18].name + "") && Y(o, s), y & /*affectedElements*/
      16 && u !== (u = /*element*/
      p[18].dot + "") && Y(a, u);
    },
    d(p) {
...
function Qt(t) {
  let e, n, r, l, c, s, o, i, u, a, d, p, y, k, _, v, q, T, Q, H, B, V, E, G, z, le, X, x = (
    /*structure*/
    t[1]
  ), I = [];
  ...
  return G = new ze({
    ...
    c() {
      e = g("merger"), n = g("div"), r = g("h3"), r.textContent = "Structure", l = O(), c = g("ul");
      for (let f = 0; f < I.length; f += 1)
        I[f].c();
      s = O(), o = g("div"), i = g("h3"), i.textContent = "Duplicate Types", u = O(), a = g("div"), ee(d.$$.fragment), p = O(), y = g("ul");
      for (let f = 0; f < D.length; f += 1)
        D[f].c();
      k = O(), _ = g("div"), v = g("h3"), v.textContent = "Affected Nodes", q = O(), T = g("ul");
      for (let f = 0; f < R.length; f += 1)
        R[f].c();
      Q = O(), H = g("div"), B = g("select"), V = g("option"), V.textContent = "Select a merge target";
      for (let f = 0; f < F.length; f += 1)
        F[f].c();
      E = O(), ee(G.$$.fragment), b(c, "class", "structure-list svelte-ejwarz"), b(n, "class", "structure svelte-ejwarz"), b(a, "class", "select-all-container svelte-ejwarz"), b(y, "class", "list svelte-ejwarz"), b(o, "class", "list-container svelte-ejwarz"), b(T, "class", "svelte-ejwarz"), b(_, "class", "usage svelte-ejwarz"), V.__value = -1, V.value = V.__value, V.disabled = !0, V.selected = !0, b(B, "data-testid", "merger_merge-target"), b(H, "class", "action svelte-ejwarz"), b(e, "class", "svelte-ejwarz");
    },
    m(f, L) {
      A(f, e, L), h(e, n), h(n, r), h(n, l), h(n, c);
      for (let M = 0; M < I.length; M += 1)
        I[M].m(c, null);
      h(e, s), h(e, o), h(o, i), h(o, u), h(o, a), Z(d, a, null), h(o, p), h(o, y);
      for (let M = 0; M < D.length; M += 1)
        D[M].m(y, null);
      h(e, k), h(e, _), h(_, v), h(_, q), h(_, T);
      for (let M = 0; M < R.length; M += 1)
        R[M].m(T, null);
      h(e, Q), h(e, H), h(H, B), h(B, V);
    ...
    p(f, [L]) {
      ...
      2) {
        ...
        for (m = 0; m < x.length; m += 1) {
          const W = Pe(f, x, m);
          I[m] ? I[m].p(W, L) : (I[m] = Re(W), I[m].c(), I[m].m(c, null));
        }
        for (; m < I.length; m += 1)
          I[m].d(1);
        I.length = x.length;
      }
      if (L & /*checkedIndexes, items, handleSourceChange*/
      69) {
        U = /*items*/
        f[0];
        let m;
        for (m = 0; m < U.length; m += 1) {
          const W = Qe(f, U, m);
          D[m] ? (D[m].p(W, L), S(D[m], 1)) : (D[m] = Fe(W), D[m].c(), S(D[m], 1), D[m].m(y, null));
        }
        for (pe(), m = U.length; m < D.length; m += 1)
          re(m);
        ge();
      }
      if (L & /*affectedElements*/
      16) {
        se = /*affectedElements*/
        f[4];
        let m;
        for (m = 0; m < se.length; m += 1) {
          const W = qe(f, se, m);
          R[m] ? R[m].p(W, L) : (R[m] = Ue(W), R[m].c(), R[m].m(T, null));
        }
        for (; m < R.length; m += 1)
          R[m].d(1);
        R.length = se.length;
      ...
      1) {
        ...
        for (m = 0; m < fe.length; m += 1) {
          const W = Be(f, fe, m);
          F[m] ? F[m].p(W, L) : (F[m] = Je(W), F[m].c(), F[m].m(B, null));
        }
        for (; m < F.length; m += 1)
          F[m].d(1);
        F.length = fe.length;
      }
      (!z || L & /*selectedMergeTargetIndex*/
      8) && Le(
        B,
        /*selectedMergeTargetIndex*/
        f[3]
    ...
    d(f) {
      f && w(e), ie(I, f), $(d), ie(D, f), ie(R, f), ie(F, f), $(G), le = !1, X();
    }
  };
}
function Pt(t, e, n) {
...
class Rt extends ne {
  constructor(e) {
    super(), te(this, e, Pt, Qt, K, { items: 0, structure: 1 });
  }
}
const Ft = {
  name: "",
...
function Xe(t) {
  ...
  return {
    c() {
      e = g("label"), n = g("input"), s = O(), o = g("div"), u = j(i), a = O(), b(n, "type", "radio"), b(n, "name", "option"), b(n, "id", r = /*option*/
    ...
    m(k, _) {
      A(k, e, _), h(e, n), h(e, s), h(e, o), h(o, u), h(e, a), p || (y = oe(
        n,
        "change",
        /*change_handler*/
        t[3]
  ...
  return {
    c() {
      ...
      for (let l = 0; l < r.length; l += 1)
        r[l].c();
      b(e, "class", "btn-group svelte-58nl5q"), b(e, "data-testid", "button-group"), ce(
        e,
        "disabled",
        /*disabled*/
        t[2]
...
class Xt extends ne {
  constructor(e) {
    super(), te(this, e, Vt, Jt, K, { selectedID: 0, options: 1, disabled: 2 });
  }
}
function Ke(t) {
  ...
  return {
    ...
    p(c, s) {
      ...
      3 && K(e, e = `${/*selectedGroupIndex*/
      c[0]}_${/*selectedType*/
      c[1]}`) ? (pe(), C(l, 1, 1, J), ge(), l = We(c), l.c(), S(l, 1), l.m(n.parentNode, n)) : l.p(c, s);
    },
    i(c) {
      r || (S(l), r = !0);
    },
...
function Kt(t) {
  ...
  return {
    c() {
      ee(e.$$.fragment), n = O(), r = g("dedupe"), l = g("layout"), c = g("sidebar"), s = g("h3"), s.textContent = "Duplicates", o = O(), i = g("div"), ee(u.$$.fragment), a = O(), ee(d.$$.fragment), p = O(), y = g("main"), _ && _.c(), b(c, "class", "svelte-ltuqys"), b(y, "class", "svelte-ltuqys"), b(l, "class", "svelte-ltuqys"), b(r, "class", "svelte-ltuqys");
    },
    m(v, q) {
      Z(e, v, q), A(v, n, q), A(v, r, q), h(r, l), h(l, c), h(c, s), h(c, o), h(c, i), Z(u, i, null), h(c, a), Z(d, c, null), h(l, p), h(l, y), _ && _.m(y, null), t[11](r), k = !0;
    },
    p(v, [q]) {
      const T = {};
      q & /*itemSets*/
    ...
    d(v) {
      $(e, v), v && w(n), v && w(r), $(u), $(d), _ && _.d(), t[11](null);
    }
  };
}
function Wt(t, e) {
...
function Zt(t, e, n) {
  ...
  let a = [];
  function d(E) {
    return E ? E.map((G) => G.map((z) => ({
      label: z.element.id,
      usages: z.usages.map(p)
    }))) : [];
  }
  function p(E) {
    const G = "~name not found~", z = E.element.parentElement;
    if (!z)
      return Ft;
    const le = ["id", "name", "desc"];
    let X = G;
    for (const I of le) {
      const U = z.getAttribute(I);
      if (U) {
        X = U;
        break;
      }
    }
    return { name: X, type: z.tagName };
  }
  let y = -1;
  function k(E) {
  ...
  function Q(E, G) {
    ...
    const I = X[0], D = Array.from(I.element.element.children).map((re) => re.getAttribute("name") ?? re.textContent ?? "~");
  ...
  function B(E) {
    const { selectedIndexes: G, selectedMergeTargetIndex: z } = E.detail, le = i[y], X = G.map((re) => le[re]), x = le[z], U = { action: { actions: X.map((re) => re.usages.map((se) => Wt(se, x.element))).flat() } }, D = new CustomEvent("editor-action", { detail: U, composed: !0, bubbles: !0 });
    s.dispatchEvent(D);
  }
  function V(E) {
    De[E ? "unshift" : "push"](() => {
...
class $t extends ne {
  constructor(e) {
    super(), te(this, e, Zt, Kt, K, { doc: 9 });
  }
}
const rt = "@oscd-plugins/dedupe", xt = "0.0.9";
function Ze(t) {
  let e = (
    /*doc*/
    t[0]
  ...
  return {
    ...
    p(c, s) {
      s & /*doc*/
      1 && K(e, e = /*doc*/
      c[0]) ? (pe(), C(l, 1, 1, J), ge(), l = $e(c), l.c(), S(l, 1), l.m(n.parentNode, n)) : l.p(c, s);
    },
    i(c) {
      r || (S(l), r = !0);
    },
...
function en(t) {
  ...
  return {
    c() {
      s && s.c(), e = O(), n = g("input"), r = O(), l = g("input"), b(n, "type", "hidden"), b(n, "name", "package-name"), n.value = rt, b(l, "type", "hidden"), b(l, "name", "package-version"), l.value = xt;
    },
    m(o, i) {
